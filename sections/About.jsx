...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| about imanoc" textStyles="text-center" />
      <motion.p
        variants={fadeIn("up", "tween", 0.2, 1)}
        className="mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white"
      >imanocは
      <span className="font-extrabold text-white">スパイ組織</span>
      です。
      <span className="font-extrabold text-white">NOC</span>
      です。最高です。
